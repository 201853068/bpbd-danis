                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <option value="">--Pilih Level--</option>
                                    ...
                                    <option  <?php if($row2['level'] == "instansi") echo "selected"; ?>  value="instansi">Karyawan/Staff</option>
                                    <option  <?php if($row2['level'] == "bendahara") echo "selected"; ?> value="bendahara">Admin</option>
                                    <option  <?php if($row2['level'] == "it") echo "selected"; ?> value="it">Kepela Sub Bagian</option>
